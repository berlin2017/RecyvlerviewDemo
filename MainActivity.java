...
import com.berlin.recyvlerviewdemo.adapter.MyAdapter;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                Snackbar snackbar = Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                        .setAction("Action", new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Toast.makeText(MainActivity.this,"SnackBar is clicked!",Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        recyclerView = (MyRefreshRecyclerView) findViewById(R.id.main_recyclerview);
        ...
        recyclerView.setListener(new MyRefreshRecyclerView.MyOnLoadMoreListener() {
            @Override
